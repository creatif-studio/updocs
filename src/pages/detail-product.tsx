  ...
  return (
    ...
    >
      ...
      <main className="container mt-5">
        <section className="flex flex-col lg:flex-row lg:items-center mt-28 gap-12">
          <div className="flex-1 w-full md:w-1/2 lg:w-full flex flex-col gap-5">
            <h1 className='font-semibold font-poppins text-[3.25rem] leading-[4.875rem] w-fit md:w-[577px]'>Easiest way to deploy your application</h1>
            <p>
          ...
          <div className="flex-1">
            <img
              ...
              alt="Image Promo"
              className="md:w-[726.5px] md:max-w-max lg:hidden"
            />
          </div>
        </section>

        <section className="pt-40 pb-20 flex flex-col lg:flex-row gap-10 items-center">
        ...
        <section className="my-16">
          ...
          <div className="flex flex-col xl:flex-row gap-10 justify-between">
            ...
            <div className="shadow-2xl rounded-lg p-8 scale-100 lg:scale-105 bg-black text-white">
