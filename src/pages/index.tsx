    ...
    <header className={clsx('hero hero--primary', 'bg-white')}>
      <div className="container text-center flex flex-col justify-center">
        <div className='flex flex-col'>
          <h1  className="font-jakarta text-black font-bold text-[2.625rem]">
        ...
        <input type="text" className='w-full sm:w-1/2 md:w-1/4 border border-gray-300 border-solid text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder:font-poppins' placeholder='find product' />
